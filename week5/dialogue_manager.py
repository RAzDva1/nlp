...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        best_thread = pairwise_distances_argmin(question_vec.reshape(1, -1), thread_embeddings, metric='cosine') #### YOUR CODE HERE ####
        print("len = ", len(best_thread))
        print("best_thread = ", best_thread)
        print("Start")
        for i in best_thread:
            if i != 0:
                print(i)
        print("End")
